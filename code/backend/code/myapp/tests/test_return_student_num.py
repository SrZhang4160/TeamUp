...
"""
class test_return_student_num(TestCase):   
    ...
    def test_queryProject(self, enable=True):
        if enable:
            ...
            test_url = 'http://127.0.0.1:8000/return_student_with_proj_num_api'
            data = {
                            "HTTP_X_TOKEN": "-1",
                    }
            self.response = self.client.post(test_url, json.dumps(data), content_type="application/json")
            ...
            test_url = 'http://127.0.0.1:8000/return_student_without_proj_num_api'
            data = {
                            "HTTP_X_TOKEN": "-1",
                    }
            self.response = self.client.post(test_url, json.dumps(data), content_type="application/json")
