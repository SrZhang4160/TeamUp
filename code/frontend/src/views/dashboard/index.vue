      ...
      <div class="project_content">
        <div class="content_left">
          ...
          <div class="content_left_button">
            <el-button type="info" round @click="button('Web')">Web app</el-button>
            ...
            <el-button type="info" round @click="button('Others')">Other languages</el-button>
          </div>
          <div class="content_left_content">
            <div v-for="(item, index) in projectList" :key="index" class="content_card" @click="goDetail(item)">
              ...
              <p>Keywords:<span>{{ item.keywords | ellipsis }}</span></p>
              <p>Type:<span v-for="(items,indexs) in item.type" :key="indexs">{{ items+' '+' ' }}</span></p>
              <p>Skill wanted:<span>{{ item.skillWanted | ellipsis }}</span></p>
            </div>
          </div>
        </div>
